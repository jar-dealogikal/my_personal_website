const navigation = {
	social: [
		...
		{
			name: "GitHub",
			href: "https://github.com/jar-dealogikal",
			icon: (props) => (
				<svg fill="currentColor" viewBox="0 0 24 24" {...props}>
					<path
						fillRule="evenodd"
	...
	return (
		<footer id="footer" aria-labelledby="footer-heading">
			...
			<div className="mx-auto max-w-7xl px-6 pb-8 pt-20 sm:pt-24 lg:px-8 lg:pt-32">
				...
				<div className="mt-16 border-t border-white pt-8 lg:mt-24">
					<p className="mt-8 text-xs text-center leading-5 text-gray-100 md:order-1 md:mt-0">
						&copy; 2024 Janm Arch Rubio, Inc. All rights reserved.
					</p>
				</div>
			</div>
		</footer>
